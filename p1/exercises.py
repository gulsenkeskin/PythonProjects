...
engineering = ogrenciler[0:3]
medicine = ogrenciler[3:6]

def func2(text,list):
     for i,val in enumerate(list):
         print(text,i+1 ,".", "öğrenci:", val)

func2("Mühendislik Fakültesi", engineering)
func2("Tıp Fakültesi",medicine)
